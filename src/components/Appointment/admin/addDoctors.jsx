        ...
        return(
            <div style={{background:"#ffff"}}>
                <div className="container vhsda2">
                    <h5 className="fw-bold text-center mb-5" >Basic Details</h5>
                        ...
                        <div className="form-group col-lg-4 col-md-6 col-12">
                            ...
                            <input type="text" className="form-control jnhXd4" name="" placeholder="" onChange={this.handleChange} />
                        </div>
                        <div className="form-group col-lg-4 col-md-6 col-12">
                        ...
                        <div className="form-group col-lg-4 col-md-6 col-12">
                            ...
                            <Select isMulti={true} className="" value={selectedOption} onChange={this.handleChange} options={optionArr}/>
